            ...
            <div className="pl-20 flex flex-col text-white">
                ...
                <div className="carousel w-1/2 m-auto my-16 ">
                    <div id="slide1" className="carousel-item relative w-full">
                        ...
                        <img
                            src={nelsonMandela}
                            className="w-40 rounded-full border-2border-gray-400" />
                            <p className="text-xl text-gray-200">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 px-[15%]">
                        <img
                            ...
                            className="w-40 rounded-full border-2border-gray-400" />
                            <p className="text-xl text-gray-200">
                                {"A persn who  never made a mistake never tried anything new."}
                            </p>
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 px-[15%]">
                        <img
                            ...
                            <h3 className="text-2xl font-semibold">Bills Gates</h3>
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide4" className="btn btn-circle">❮</a>
                            <a href="#slide1" className="btn btn-circle">❯</a>
                        </div>
